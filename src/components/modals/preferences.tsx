...
import { Modal as ModalModel, Preferences } from '../../store';
...
const PreferencesModal = auto(
  (props: { modal: ModalModel; preferences: Preferences }) => {
    console.log('render preferences modal');
    const { modal, preferences } = props;
    return (
      <Modal
        open={modal.isOpen}
        footer={
